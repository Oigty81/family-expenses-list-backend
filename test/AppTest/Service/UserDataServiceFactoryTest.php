...
use App\Service\UserDataServiceFactory;

class UserDataServiceFactoryTest extends TestCase
{
    use ProphecyTrait;
    ...
    {
        $factory = new UserDataServiceFactory();

        $userDataService = $factory($this->container->reveal());

        $this->assertInstanceOf(UserDataService::class, $userDataService);
    }
}